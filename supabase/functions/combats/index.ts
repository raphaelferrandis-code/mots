...
if (!adresse || !cle) throw new Error('Configuration serveur des combats absente.');
Deno.serve(creerRuntimeCombat(adresse, cle, {
  cartes: donnees.cartes as CarteIndex[],
  definitions: new Map(donnees.definitions as [string, Definition[]][]),
}));
