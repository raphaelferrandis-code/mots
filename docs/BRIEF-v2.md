...
| 44 | **L'offre payante** | **Décidée le 22/09/2026.** Trois formules qui se contiennent : **Le nécessaire 5,99 € une fois** (paquets deux fois plus vite, réserve doublée) ; **Collectionneur 5 €/mois** (plus l'Encre gagnée ×2 et le marché sans limite) ; **Expert 10 €/mois** (plus l'histoire des prix et 300 Encre par jour). **De l'Encre s'achètera à l'unité, utilisable au marché seulement** : de l'argent n'achète jamais un paquet, donc jamais un tirage au sort. **Aucune publicité**, dans aucune formule. **Paiement réservé aux 18 ans et plus** : l'année de naissance est demandée seulement à qui regarde les formules. Détail et blocages dans `BRIEF-version-payante.md`, brouillon des conditions de vente dans `CGV-brouillon.md` |
