...
| **4. Finitions** *(en cours depuis le 21/09/2026 ; fait : page Confidentialité et suppression du profil de joute ; contrôle d'accessibilité ; sons du duel — à juger à l'oreille par Raphaël)* | Sons, effets de rareté, accessibilité, écran crédits, équilibrage, partage d'une carte en image, variantes de question | Raphaël valide le ressenti ; 5 testeurs extérieurs ont joué plusieurs jours et leurs retours sont notés |
