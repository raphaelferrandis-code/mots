...
//
// Pour brancher le serveur : suivre docs/GUIDE-supabase.md, puis écrire les deux valeurs PUBLIQUES du projet
...
export const SERVEUR = {
  ...
  // 1-structure.sql et 3-cartes.sql collés dans Supabase (docs/GUIDE-supabase.md, étape 8). Tant que c'est « false »,
  ...
  // Vide : pas de contrôle. Voir docs/GUIDE-anti-robot.md. La clé « secrète » va dans Supabase, JAMAIS ici.
