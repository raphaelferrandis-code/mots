...
export function FicheCarte({ id }: { id: string }) {
  ...
  const partager = async (): Promise<void> => {
    ...
    try {
      const issue = await partagerLeTimbre(carte, page, { finition, obtenuLe: possedee?.obtenueLe ?? null });
    ...
    <main className="ecran">
      <article className="fiche">
        ...
        <div className="fiche__visuel">
          <div className="fiche__carte"><TimbreManipulable key={carte.id} carte={carte} finition={finition} obtenuLe={possedee?.obtenueLe ?? null} /></div>
