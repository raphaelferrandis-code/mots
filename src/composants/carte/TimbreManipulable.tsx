...
export function TimbreManipulable({ carte, finition, maitriseeLe }: { carte: CarteIndex; finition: Finition; maitriseeLe: number | null }) {
  ...
  return <div className="timbre-objet">
    <div className="timbre-objet__scene" role="group" tabIndex={0}
      ...
      <div className="timbre-objet__rotation" style={{ '--rotation-x': `${angle.x}deg`, '--rotation-y': `${angle.y}deg` } as CSSProperties}>
        <div className="timbre-objet__face" aria-hidden={verso}><Carte carte={carte} finition={finition} maitriseeLe={maitriseeLe} cliquable={false} /></div>
