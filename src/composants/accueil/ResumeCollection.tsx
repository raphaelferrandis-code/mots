...
export function ResumeCollection({ collection, erreur }: { collection: VueAccueil['collection'] | null; erreur?: string }) {
    ...
    <section className="resume-collection" aria-labelledby="titre-collection">
      ...
      <div className="resume-collection__progression">
        {collection ? <>
          ...
          <p className="resume-collection__details">{collection.horsSeriePossedees} / {collection.horsSerieTotal} hors-série</p>
